...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./selection/index.js":"../node_modules/d3-transition/src/selection/index.js","./transition/index.js":"../node_modules/d3-transition/src/transition/index.js","./active.js":"../node_modules/d3-transition/src/active.js","./interrupt.js":"../node_modules/d3-transition/src/interrupt.js"}],"js/d3Import.js":[function(require,module,exports) {
"use strict";
...
},{"d3-selection":"../node_modules/d3-selection/src/index.js","d3-scale":"../node_modules/d3-scale/src/index.js","d3-array":"../node_modules/d3-array/src/index.js","d3-transition":"../node_modules/d3-transition/src/index.js"}],"js/index.js":[function(require,module,exports) {
"use strict";

var d3 = _interopRequireWildcard(require("./d3Import"));
...
var highscores = data.map(function (item) {
  return item.highscore;
});
var min = d3.min(highscores);
var max = d3.max(highscores);
var scale = d3.scaleLinear().domain([max, 0]).range([0, height]); // console.log(height)
// console.log(scale(25000))

var bars = g.selectAll('rect');
bars.data(data).enter().append('rect').attr('id', function (d) {
  return d.name;
}).attr('x', function (d, i) {
  return i * 40;
}).attr('y', function (d) {
  return scale(d.highscore);
}).attr('width', 35).transition().duration(2000).attr('height', function (d) {
  return height - scale(d.highscore);
});
},{"./d3Import":"js/d3Import.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
